...
# ── Figure defaults ────────────────────────────────────────────────────
# What sidecars / companions the AI ships with every figure. Auto-
# generated .summary.md stubs tended to leak into papers as placeholder
# captions; SVG companions doubled disk and audit noise. The opinionated
# default is: one .png + one .caption.md, with interpretation integrated
# into conclusions.md. Opt in below per project when the editorial
# pipeline actually consumes the extras.
figures:
  svg_allowed: false             # ship .svg next to .png? off by default
  summary_sidecar: false         # auto-emit .summary.md sidecars? off by default
