"""Dashboard app — single-page web app renderer (default).
...
toggle + reactive tables. The legacy renderer (``render_dashboard`` in
...
def render_dashboard_app(
    ...
    try:
        ...
        if pack == "qualitative":
            try:
                from research_os.tools.actions.synthesis.dashboard_qualitative \
            ...
            try:
                from research_os.tools.actions.synthesis.dashboard_humanities \
