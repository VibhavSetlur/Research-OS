...
_STUB_ARGS: dict[str, dict] = {
    ...
    "tool_humanities_citation_chain":      {"seed_citation": "Smith 2020"},
    "tool_qualitative_codebook_diff":      {"codebook_v1": "a.yaml", "codebook_v2": "b.yaml"},
    "tool_qualitative_quote_provenance":   {"quote": "x"},
    "tool_qualitative_select_standard":    {"standard": "COREQ"},
    "tool_theory_math_lean_check":         {"target": "x.lean"},
    "tool_theory_math_coq_check":          {"target": "x.v"},
    "tool_theory_math_dep_graph":          {"sources": []},
    "tool_wet_lab_plate_map_render":       {"plate": {"format": "96", "wells": {}}},
    "tool_wet_lab_reagent_query":          {"query": "Tris"},
    "tool_wet_lab_sample_lineage_export":  {"sample_id": "S1"},
    "tool_engineering_fmea_render":        {"items": []},
    "tool_engineering_fault_tree_render":  {"tree": {}},
    "tool_engineering_requirements_matrix": {"requirements": []},
    # Adapter tools
    "tool_slurm_job_status":          {"job_id": "12345"},
    "tool_slurm_estimate_cost":       {"wall_time_minutes": 10, "cpus": 1},
    "tool_snakemake_dryrun":          {"workflow": "Snakefile"},
    "tool_snakemake_dag_render":      {"workflow": "Snakefile"},
    "tool_nextflow_validate":         {"workflow": "main.nf"},
    "tool_cytoscape_export_static":   {"network_id": "n1"},
    "tool_redcap_schema_describe":    {"project": "p1"},
    "tool_synapse_entity_info":       {"entity_id": "syn123"},
}
