...
| `tool_poster_create` | Typst (default) or Tikzposter LaTeX poster. **v2.0.0:** Typst path is wrapped in a review-rewrite loop (presentation_critic + novelty_critic, max 2 iterations). |
